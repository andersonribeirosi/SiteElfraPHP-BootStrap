...
<body>
	<div class="container" align="center">
		<form action="cadusu.php" method="post" class="form-cadusu">
			...
			<button type="submit" class="btn btn-lg btn-primary btn-block btn-success" onClick="window.open('login.php')">Cadastrar</button>
		</form>
	</div>


	<form action="cadusu.php" method="post" class="form-login">
			<h4 align="center" class="form-login-heading">ou</h4>
		
		<a href="cadusu.php"><button type="submit" class="btn btn-lg btn-primary btn-block">Fazer Login</button></a>
